    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full group hover:shadow-md hover:border-[#379c6b]/30 transition-all duration-300 p-3">
      ...
      <div className="flex flex-col flex-grow">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button className="w-8 h-8 rounded-lg flex items-center justify-center border border-slate-200 bg-white text-slate-400 hover:text-[#379c6b] hover:border-[#379c6b] transition-all flex-shrink-0">
            <FiRepeat size={14} />
          </button>
        </div>
