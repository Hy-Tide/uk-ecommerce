...
import { FaWhatsapp } from 'react-icons/fa'; // Notice using fa for Whatsapp, I might need to make sure react-icons/fa is available. I'll use FiMessageCircle if not, or try FaWhatsapp
...
const WhatsAppFloatingBtn = () => {
  return (
    <a
      ...
      className="fixed bottom-24 lg:bottom-8 right-6 lg:right-8 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center group"
      aria-label="Contact Support on WhatsApp"
    >
      <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-20"></div>
      {/* Assuming FaWhatsapp is available in react-icons/fa */}
      <svg 
        stroke="currentColor" 
        fill="currentColor" 
        strokeWidth="0" 
