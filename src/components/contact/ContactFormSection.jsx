              ...
              <form onSubmit={handleSubmit} className="flex flex-col h-full">
                ...
                <div className="flex items-center gap-3 mb-8">
                  <div className="relative flex items-center">
                    <input name="agree" checked={formData.agree} onChange={handleChange} type="checkbox" required className="w-5 h-5 border-slate-300 rounded text-[#2E8B57] focus:ring-[#2E8B57] cursor-pointer" />
                  </div>
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full md:w-auto mt-auto bg-[#2E8B57] hover:bg-[#236b43] disabled:opacity-70 text-white font-bold text-lg px-10 py-4 rounded-[16px] shadow-[0_8px_20px_rgba(46,139,87,0.25)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3"
                >
