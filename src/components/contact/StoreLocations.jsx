      ...
      <div className="container px-4">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-500 text-lg max-w-2xl">
            Visit our main flagship store in London. We offer click-and-collect and in-store shopping.
          </p>
        </div>
        ...
        <div className="bg-[#fcfbf9] rounded-[32px] border border-slate-100 overflow-hidden flex flex-col lg:flex-row shadow-sm">
          ...
          <div className="w-full lg:w-1/2 p-8 lg:p-12">
            ...
            <p className="text-[#2E8B57] font-bold text-lg mb-8">Central Fulfillment</p>
