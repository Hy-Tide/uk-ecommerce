    ...
    <div className="bg-[#F8F9FA] min-h-screen py-12">
      <div className="container">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h1 className="text-3xl md:text-4xl font-black text-[#0C3823] mb-3">Our Trusted Brands</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {brands.map((brand) => (
              <Link 
                ...
                className="bg-white rounded-3xl p-6 flex flex-col items-center text-center shadow-sm border border-slate-100 hover:shadow-xl hover:border-[#FF6B00]/30 hover:-translate-y-1 transition-all duration-300 group"
              >
                ...
                <h3 className="font-black text-lg text-[#0C3823] mb-2 group-hover:text-[#FF6B00] transition-colors line-clamp-1">
                  {brand.name}
                </h3>
                {brand.description && (
