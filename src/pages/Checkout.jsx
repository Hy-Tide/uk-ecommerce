    ...
    try {
      ...
      if (selectedPaymentMethod === 'stripe') {
        ...
        if (intentRes && intentRes.success !== false && intentRes.data?.clientSecret) {
          ...
          setPublishableKey(intentRes.data.publishableKey || 'pk_test_TYooMQauvdEDq54NiTphI7jx');
        } else {
    ...
    <div className="bg-[#F8F9FA] pb-24 min-h-screen">
      ...
      <div className="bg-white border-b border-slate-100 py-6">
        <div className="container max-w-3xl flex items-center justify-center">
          ...
          <div className="flex items-center gap-2">
            <div className={`w-8 h-8 rounded-full ${clientSecret ? 'bg-[#124827] text-white' : 'bg-[#fafcfb] border-2 border-slate-200 text-slate-400'} flex items-center justify-center font-bold text-xs`}>
              3
            </div>
            <span className={`${clientSecret ? 'text-[#124827]' : 'text-slate-400'} font-bold text-xs`}>Payment Gateway</span>
          </div>
      ...
      <div className="container pt-8">
        {clientSecret ? (
          /* Dedicated Stripe Payment Focus Card - Hides all other forms */
          <div className="max-w-xl mx-auto">
            <div className="border border-slate-200 rounded-3xl bg-white overflow-hidden shadow-xl">
              
              {/* Header */}
              <div className="bg-[#124827] text-white p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center text-white">
                    <FaCcStripe size={24} />
                  </div>
                  <div>
                    <h2 className="text-lg font-black tracking-tight">Stripe Secure Checkout</h2>
                    <p className="text-xs text-emerald-100 font-medium">Complete your payment safely</p>
                  </div>
                </div>

                <div className="text-right">
                  <span className="text-[10px] font-bold text-slate-200 block uppercase tracking-wider">Payable</span>
                  <span className="text-xl font-black text-[#FF6B00]">£{grandTotal.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 text-center">
                  <button
                    ...
                    className="text-xs font-bold text-slate-500 hover:text-[#124827] transition-colors underline underline-offset-2"
                  >
                    ← Change Shipping Address or Delivery Slot
                  </button>
                </div>
              </div>
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-24">
                ...
                <div className="border border-slate-200/80 rounded-2xl bg-white overflow-hidden shadow-sm mb-6">
                  ...
                  <div className="p-6">
                    ...
                    >
                      ...
                      {isLoading ? 'Initiating Payment...' : 'Proceed to Payment'}
                    </button>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-[#FAFCFB] border border-slate-100 rounded-2xl p-4 flex flex-col items-center justify-center text-center gap-2">
                    <FiShield size={20} className="text-[#124827]" />
                    <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">SSL Encrypted</span>
                  </div>
                  <div className="bg-[#FAFCFB] border border-slate-100 rounded-2xl p-4 flex flex-col items-center justify-center text-center gap-2">
                    <FiTruck size={20} className="text-[#124827]" />
                    <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">Fast Shipping</span>
                  </div>
                </div>
